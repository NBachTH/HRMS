"""Generate tuan8_report.docx from tuan8_report.md."""
import re, os
...
def render_inline(para, text, base_size=10.5):
    ...
    while i < n:
        ...
        if h_match:
            ...
            if level == 1:
                ...
                bottom2.set(qn('w:sz'), '8')
                bottom2.set(qn('w:space'), '2')
                bottom2.set(qn('w:color'), '2E4057')
                pBdr.append(bottom2)
                pPr.append(pBdr)
...
if __name__ == '__main__':
    ...
    build_docx(
        os.path.join(base, 'tuan8_report.md'),
        os.path.join(base, 'tuan8_report.docx'),
    )
